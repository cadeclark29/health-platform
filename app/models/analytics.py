...
class SupplementStart(Base):
    ...
    # Common supplement library for manual entry (id, name, typical_dose, unit)
    SUPPLEMENT_LIBRARY = [
        ("vitamin_d3", "Vitamin D3", "2000-5000", "IU"),
        ("fish_oil", "Fish Oil / Omega-3", "1000-2000", "mg"),
        ("magnesium", "Magnesium", "200-400", "mg"),
        ("magnesium_glycinate", "Magnesium Glycinate", "200-400", "mg"),
        ("zinc", "Zinc", "15-30", "mg"),
        ("b_complex", "B-Complex", "1", "capsule"),
        ("vitamin_b12", "Vitamin B12", "500-1000", "mcg"),
        ("creatine", "Creatine", "3-5", "g"),
        ("protein_powder", "Protein Powder", "20-30", "g"),
        ("melatonin", "Melatonin", "0.5-5", "mg"),
        ("probiotics", "Probiotics", "1", "capsule"),
        ("iron", "Iron", "18-27", "mg"),
        ("vitamin_c", "Vitamin C", "500-1000", "mg"),
        ("multivitamin", "Multivitamin", "1", "tablet"),
        ("caffeine", "Caffeine", "100-200", "mg"),
        ("ashwagandha", "Ashwagandha", "300-600", "mg"),
        ("l_theanine", "L-Theanine", "100-200", "mg"),
        ("collagen", "Collagen", "10-15", "g"),
        ("coq10", "CoQ10", "100-200", "mg"),
        ("turmeric", "Turmeric / Curcumin", "500-1000", "mg"),
        ("elderberry", "Elderberry", "500", "mg"),
        ("lions_mane", "Lion's Mane", "500-1000", "mg"),
        ("rhodiola", "Rhodiola Rosea", "200-400", "mg"),
        ("gaba", "GABA", "250-500", "mg"),
        ("glycine", "Glycine", "3", "g"),
